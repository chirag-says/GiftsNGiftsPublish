...
function Analytics() {
  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-0">
      ...
      <div className="flex flex-col space-y-4 md:flex-row justify-between items-start md:items-center">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          <select
            ...
            className="flex-1 sm:flex-none px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
          ...
          <button
            ...
            disabled={exporting}
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 shadow-sm transition-all disabled:opacity-50 text-sm whitespace-nowrap"
          >
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 p-5 rounded-xl text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-xl md:text-2xl font-bold mt-1">{formatCurrency(stats.totalRevenue)}</h4>
                    </div>
                  ...
                  <div className="flex items-center gap-1 mt-3 text-sm">
                    {stats.revenueGrowth >= 0 ? <MdTrendingUp className="text-green-300" /> : <MdTrendingDown className="text-red-300" />}
                    <span className={stats.revenueGrowth >= 0 ? 'text-green-300' : 'text-red-300'}>{Math.abs(stats.revenueGrowth)}%</span>
                ...
                <div className="bg-white border border-gray-200 p-5 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-xl md:text-2xl font-bold text-gray-900 mt-1">{stats.totalOrders}</h4>
                    </div>
                    <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                      <MdShoppingCart className="text-xl text-green-600" />
                    </div>
                  </div>
                  <div className="flex items-center gap-1 mt-3 text-sm">
                ...
                <div className="bg-white border border-gray-200 p-5 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-xl md:text-2xl font-bold text-gray-900 mt-1">{stats.conversionRate}%</h4>
                    </div>
                ...
                <div className="bg-white border border-gray-200 p-5 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-xl md:text-2xl font-bold text-gray-900 mt-1">{formatCurrency(stats.avgOrderValue)}</h4>
                    </div>
                    <div className="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center">
                      <FiActivity className="text-xl text-amber-600" />
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 p-4 sm:p-6 rounded-xl overflow-hidden">
                ...
                <div className="bg-white border border-gray-200 p-4 sm:p-6 rounded-xl">
                  ...
                  <div className="space-y-3 max-h-[350px] overflow-y-auto pr-2">
                    {productData.map((product, index) => (
                      <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-50 rounded-lg gap-2">
                        <div className="flex items-center gap-3">
                          <div className="w-3 h-3 rounded-full shrink-0" style={{ backgroundColor: COLORS[index % COLORS.length] }}></div>
                          <span className="font-medium text-gray-800 text-sm truncate max-w-[150px] sm:max-w-[200px]">{product.name}</span>
                        </div>
                        <div className="flex items-center justify-between w-full sm:w-auto sm:gap-4">
                          <span className="text-gray-500 text-xs">{product.sales || product.value} sales</span>
                          <span className="font-semibold text-gray-900 text-sm">{formatCurrency(product.value * 10)}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="h-64 sm:h-80 w-full overflow-x-auto">
                  <ResponsiveContainer width="99%" height="100%">
                    <AreaChart data={revenueData}>
                      ...
                      <Tooltip />
                      <Area type="monotone" dataKey="orders" stroke="#10B981" fill="#D1FAE5" strokeWidth={2} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div className="bg-white border border-gray-200 p-4 sm:p-5 rounded-xl shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-gray-500 text-xs font-medium uppercase truncate">Total Visitors</p>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900">{stats.totalVisitors.toLocaleString()}</h4>
                    </div>
                  </div>
                </div>
                <div className="bg-white border border-gray-200 p-4 sm:p-5 rounded-xl shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-gray-500 text-xs font-medium uppercase truncate">New Customers</p>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900">{Math.round(stats.totalVisitors * 0.15).toLocaleString()}</h4>
                    </div>
                  </div>
                </div>
                <div className="bg-white border border-gray-200 p-4 sm:p-5 rounded-xl shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-gray-500 text-xs font-medium uppercase truncate">Conversion Rate</p>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900">{stats.conversionRate}%</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 p-4 sm:p-6 rounded-xl">
                  ...
                  <div className="h-64 sm:h-80 w-full overflow-x-auto">
                    <ResponsiveContainer width="99%" height="100%">
                      <PieChart>
                        <Pie data={trafficData} cx="50%" cy="45%" outerRadius="75%" dataKey="value">
                          {trafficData.map((entry, index) => (
                            <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                          ))}
                        </Pie>
