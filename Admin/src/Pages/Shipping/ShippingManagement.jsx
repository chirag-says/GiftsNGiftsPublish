...
const ShippingManagement = () => {
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="mb-6">
                <h1 className=" text-2xl sm:text-3xl font-bold text-gray-800">Fulfillment & Logistics</h1>
                <p className="text-gray-500 text-[14px] sm:text-[16px]">Manage shipping carriers, zones, payments, and tracking</p>
            </div>
