        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.autoLogin && data.user) {
                    ...
                    // Reset all forgot password states and go to login
...
const verifyOtp = async (e) => {
  ...
  try {
    ...
    return (
        <form className="min-h-screen flex items-center justify-center bg-gray-50 p-2">
            <div className="w-full max-w-xl bg-white p-5 md:p-10 shadow-2xl rounded-2xl border-t-4 border-indigo-600">
                                ...
                                <fieldset className="p-0 m-0 border-none space-y-4">
                                    ...
                                    <div>
                                        ...
                                        {phone && phone.length !== 10 && (
                                            <p className="text-xs text-amber-600 mt-1">{phone.length}/10 digits</p>
                                        )}
                                    </div>
                                </fieldset>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            {pincode && pincode.length !== 6 && (
                                                <p className="text-xs text-amber-600 mt-1">{pincode.length}/6 digits</p>
                                            )}
                                        </div>
                                    </div>
                                </fieldset>
