    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="flex sm:flex-row flex-col gap-4 justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Gift Options Management</h1>
                    <p className="text-gray-500 text-[14px] sm:text-[16px]">Manage wrappers, cards, packaging, and corporate gifting</p>
                </div>
                <Button
                    variant="contained"
                    startIcon={<MdAdd />}
                    onClick={() => { setEditingId(null); setShowForm(!showForm); }}
                    className="!bg-purple-600 text-[12px] !hover:bg-purple-700"
                >
