  ...
  const navLinks = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: "header", title: "KYC & ONBOARDING" },
        { title: "Seller Verification", path: "/verification" },
      ]
    },
    {
      ...
      submenu: [
        ...
        { title: "Category Requests", path: "/category-requests" },
        { title: "Subcategory Requests", path: "/subcategory-requests" },
