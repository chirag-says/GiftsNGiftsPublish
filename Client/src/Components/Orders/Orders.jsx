  ...
  <React.Fragment>
    <tr className={`group transition-all duration-300 ${isOpen ? 'bg-purple-50/40' : 'hover:bg-gray-50'}`}>
      ...
      <td className="px-6 py-5 text-right">
        <button
          onClick={onToggle}
          className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold transition-all transform active:scale-95 ${isOpen ? 'bg-purple-600 text-white shadow-lg shadow-purple-200' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            }`}
        >
