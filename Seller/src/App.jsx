...
import AddProductWizard from './Pages/Product Pages/AddProductWizard';
  ...
  return (
    <section className="main h-screen w-full flex flex-col bg-[#F9FAFB]">
      ...
      <div className="flex w-full overflow-hidden flex-1">
        ...
        <main className="flex-1 py-4 px-2 lg:px-6 overflow-y-auto bg-[#F9FAFB]">
          {children}
        </main>
      </div>
    </section>
  ...
  return (
    <MyContext.Provider value={values}>
      ...
      >
        ...
        {isOpenAddProductPanel?.model === 'Add Product' && <AddProductWizard />}
